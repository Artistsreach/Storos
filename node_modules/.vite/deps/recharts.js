    ...
    function areObjectsEqual(a, b, stack, areValuesEqual) {
      ...
      try {
        switch (aTag) {
          ...
          case tags.objectTag: {
            const areEqualInstances = areObjectsEqual(a.constructor, b.constructor, stack, areValuesEqual) || isPlainObject6.isPlainObject(a) && isPlainObject6.isPlainObject(b);
...
var require_isEqual = __commonJS({
  "node_modules/es-toolkit/dist/predicate/isEqual.js"(exports) {
    ...
    function isEqual3(a, b) {
      return isEqualWith2.isEqualWith(a, b, noop7.noop);
    }
  ...
  if (isRange) {
    points.forEach((point2) => {
      if (Array.isArray(point2.value)) {
        ...
        baseLinePoints.push(_objectSpread33(_objectSpread33({}, point2), {}, {
          radius
...
function typeguardBarRectangleProps(_ref2, props) {
  ...
  return _objectSpread35(_objectSpread35(_objectSpread35(_objectSpread35(_objectSpread35({}, props), option), x ? {
    x
  } : {}), y ? {
    y
  } : {}), {}, {
...
var YAxisImpl = (props) => {
  ...
  (0, import_react55.useLayoutEffect)(() => {
    ...
    if (width !== "auto" || !axisSize || isLabelContentAFunction(label) || (0, import_react55.isValidElement)(label))
      return;
