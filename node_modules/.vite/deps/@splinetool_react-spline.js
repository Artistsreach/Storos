...
// node_modules/@splinetool/react-spline/dist/react-spline.js
var C = (0, import_react2.forwardRef)(
  ({
    scene: s,
    style: u,
    onSplineMouseDown: p,
    ...
    const o2 = (0, import_react2.useRef)(null), [c, a] = (0, import_react2.useState)(true), [i, R] = (0, import_react2.useState)();
    if (i)
      throw i;
    return (0, import_react2.useEffect)(() => {
      ...
      if (o2.current) {
        e = new DF(o2.current, { renderOnDemand: E });
        async function t() {
          await e.load(s);
          for (let n of m2)
