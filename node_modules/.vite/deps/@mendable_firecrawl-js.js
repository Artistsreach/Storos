...
var FirecrawlApp = class {
  ...
  async scrapeUrl(url, params) {
    ...
    if ((_a = jsonData == null ? void 0 : jsonData.extract) == null ? void 0 : _a.schema) {
    ...
    if ((_b = jsonData == null ? void 0 : jsonData.jsonOptions) == null ? void 0 : _b.schema) {
    ...
    try {
      const response = await axios_default.post(
        ...
        jsonData,
        { headers, timeout: (params == null ? void 0 : params.timeout) !== void 0 ? params.timeout + 5e3 : void 0 }
      );
  ...
  async search(query, params) {
    ...
    let jsonData = {
      query,
      limit: (params == null ? void 0 : params.limit) ?? 5,
      tbs: params == null ? void 0 : params.tbs,
      filter: params == null ? void 0 : params.filter,
      lang: (params == null ? void 0 : params.lang) ?? "en",
      country: (params == null ? void 0 : params.country) ?? "us",
      location: params == null ? void 0 : params.location,
      origin: (params == null ? void 0 : params.origin) ?? "api",
      timeout: (params == null ? void 0 : params.timeout) ?? 6e4,
      scrapeOptions: (params == null ? void 0 : params.scrapeOptions) ?? { formats: [] }
    };
    if ((_b = (_a = jsonData == null ? void 0 : jsonData.scrapeOptions) == null ? void 0 : _a.extract) == null ? void 0 : _b.schema) {
    ...
    try {
      ...
      if ((_d = (_c = error.response) == null ? void 0 : _c.data) == null ? void 0 : _d.error) {
  ...
  async extract(urls, params) {
    ...
    try {
      if (!(params == null ? void 0 : params.schema)) {
        jsonSchema = void 0;
      } else if (typeof params.schema === "object" && params.schema !== null && ((_c = (_b = (_a = Object.getPrototypeOf(params.schema)) == null ? void 0 : _a.constructor) == null ? void 0 : _b.name) == null ? void 0 : _c.startsWith("Zod"))) {
    ...
    try {
      const response = await this.postRequest(
        ...
        { ...jsonData, schema: jsonSchema, origin: (params == null ? void 0 : params.origin) || "api-sdk" },
        headers
      );
      if (response.status === 200) {
          ...
          if (extractStatus.status === "completed") {
            if (extractStatus.success) {
              return {
                ...
                sources: (extractStatus == null ? void 0 : extractStatus.sources) || void 0
              };
            } else {
      ...
      throw new FirecrawlError(error.message, 500, (_e = (_d = error.response) == null ? void 0 : _d.data) == null ? void 0 : _e.details);
    }
    return { success: false, error: "Internal server error." };
  }
  /**
  ...
  async asyncExtract(urls, params, idempotencyKey) {
    ...
    let jsonSchema;
    try {
      if ((params == null ? void 0 : params.schema) instanceof ZodType) {
        jsonSchema = zodToJsonSchema(params.schema);
      } else {
        jsonSchema = params == null ? void 0 : params.schema;
      }
    } catch (error) {
      throw new FirecrawlError("Invalid schema. Schema must be either a valid Zod schema or JSON schema object.", 400);
    }
    try {
      ...
      throw new FirecrawlError(error.message, 500, (_b = (_a = error.response) == null ? void 0 : _a.data) == null ? void 0 : _b.details);
    }
    return { success: false, error: "Internal server error." };
  }
  /**
  ...
  postRequest(url, data, headers) {
    return axios_default.post(url, data, { headers, timeout: (data == null ? void 0 : data.timeout) ? data.timeout + 5e3 : void 0 });
  }
  /**
  ...
  async getRequest(url, headers) {
    try {
      return await axios_default.get(url, { headers });
    } catch (error) {
  ...
  async deleteRequest(url, headers) {
    try {
      return await axios_default.delete(url, { headers });
    } catch (error) {
      if (error instanceof AxiosError2 && error.response) {
        return error.response;
      } else {
  ...
  handleError(response, action) {
    ...
    if ([400, 402, 403, 408, 409, 500].includes(response.status)) {
      ...
      throw new FirecrawlError(
        ...
        response.status,
        (_a = response == null ? void 0 : response.data) == null ? void 0 : _a.details
      );
    } else {
      throw new FirecrawlError(
  ...
  async asyncDeepResearch(query, params) {
    ...
    if ((_a = jsonData == null ? void 0 : jsonData.jsonOptions) == null ? void 0 : _a.schema) {
      let schema = jsonData.jsonOptions.schema;
      try {
        schema = zodToJsonSchema(schema);
      } catch (error) {
...
var CrawlWatcher = class extends e {
  constructor(id, app) {
    ...
    this.ws = new WebSocket2(`${wsUrl}/v1/crawl/${id}`, app.apiKey);
...
//# sourceMappingURL=@mendable_firecrawl-js.js.map
