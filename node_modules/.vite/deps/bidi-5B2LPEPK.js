import {
  ...
  throwIfDisposed,
  timeout
} from "./chunk-NKYH7TOY.js";
import {
  require_crypto
} from "./chunk-SNDSYIJS.js";
import "./chunk-DD35CYLH.js";
import {
  __commonJS,
  __esm,
  __export,
  ...
  "node_modules/chromium-bidi/lib/cjs/bidiMapper/modules/browser/BrowserProcessor.js"(exports) {
    ...
    var BrowserProcessor = class {
      ...
      async getClientWindows() {
        ...
        const clientWindows = await Promise.all(topLevelTargetIds.map(async (targetId) => await __privateMethod(this, _getWindowInfo, getWindowInfo_fn).call(this, targetId)));
...
var require_BrowsingContextProcessor = __commonJS({
  "node_modules/chromium-bidi/lib/cjs/bidiMapper/modules/context/BrowsingContextProcessor.js"(exports) {
    ...
    var protocol_js_1 = require_protocol();
    var _browserCdpClient, _browsingContextStorage, _contextConfigStorage, _eventManager, _userContextStorage, _getRelatedTopLevelBrowsingContexts, getRelatedTopLevelBrowsingContexts_fn, _onContextCreatedSubscribeHook, onContextCreatedSubscribeHook_fn;
    var BrowsingContextProcessor = class {
      constructor(browserCdpClient, browsingContextStorage, userContextStorage, contextConfigStorage, eventManager) {
         ...
         */
        __privateAdd(this, _getRelatedTopLevelBrowsingContexts);
        __privateAdd(this, _onContextCreatedSubscribeHook);
        __privateAdd(this, _browserCdpClient, void 0);
        __privateAdd(this, _browsingContextStorage, void 0);
        __privateAdd(this, _contextConfigStorage, void 0);
        ...
        __privateGet(this, _eventManager).addSubscribeHook(protocol_js_1.ChromiumBidi.BrowsingContext.EventNames.ContextCreated, __privateMethod(this, _onContextCreatedSubscribeHook, onContextCreatedSubscribeHook_fn).bind(this));
      }
      getTree(params) {
      ...
      async setViewport(params) {
        ...
        const impactedTopLevelContexts = await __privateMethod(this, _getRelatedTopLevelBrowsingContexts, getRelatedTopLevelBrowsingContexts_fn).call(this, params.context, params.userContexts);
    ...
    _userContextStorage = new WeakMap();
    _getRelatedTopLevelBrowsingContexts = new WeakSet();
    ...
    _onContextCreatedSubscribeHook = new WeakSet();
...
var require_EmulationProcessor = __commonJS({
  "node_modules/chromium-bidi/lib/cjs/bidiMapper/modules/emulation/EmulationProcessor.js"(exports) {
    ...
    var _userContextStorage, _browsingContextStorage, _contextConfigStorage, _getRelatedTopLevelBrowsingContexts, getRelatedTopLevelBrowsingContexts_fn;
    var EmulationProcessor = class {
      ...
      async setGeolocationOverride(params) {
        ...
        const browsingContexts = await __privateMethod(this, _getRelatedTopLevelBrowsingContexts, getRelatedTopLevelBrowsingContexts_fn).call(this, params.contexts, params.userContexts);
        for (const browsingContextId of params.contexts ?? []) {
          __privateGet(this, _contextConfigStorage).updateBrowsingContextConfig(browsingContextId, {
            geolocation
          });
        }
        for (const userContextId of params.userContexts ?? []) {
          __privateGet(this, _contextConfigStorage).updateUserContextConfig(userContextId, {
            geolocation
          });
        }
...
var require_NetworkProcessor = __commonJS({
  "node_modules/chromium-bidi/lib/cjs/bidiMapper/modules/network/NetworkProcessor.js"(exports) {
    ...
    var _browsingContextStorage, _networkStorage, _userContextStorage, _contextConfigStorage, _toggleNetwork, toggleNetwork_fn, _getRequestOrFail, getRequestOrFail_fn, _getBlockedRequestOrFail, getBlockedRequestOrFail_fn;
    var _NetworkProcessor = class _NetworkProcessor {
      constructor(browsingContextStorage, networkStorage, userContextStorage, contextConfigStorage) {
         ...
         */
        __privateAdd(this, _toggleNetwork);
      ...
      async addIntercept(params) {
        ...
        await __privateMethod(this, _toggleNetwork, toggleNetwork_fn).call(this);
        return {
          intercept
        };
      }
      async continueRequest(params) {
        ...
        const request = __privateMethod(this, _getBlockedRequestOrFail, getBlockedRequestOrFail_fn).call(this, params.request, [
          "beforeRequestSent"
        ]);
        try {
      ...
      async addDataCollector(params) {
        ...
        if (params.userContexts !== void 0) {
          await __privateGet(this, _userContextStorage).verifyUserContextIdList(params.userContexts);
        }
      ...
      async setExtraHeaders(params) {
        ...
        if (params.userContexts === void 0 && params.contexts === void 0) {
          __privateGet(this, _contextConfigStorage).updateGlobalConfig({
            extraHeaders: cdpExtraHeaders
          });
          __privateGet(this, _browsingContextStorage).getAllContexts().forEach((c) => affectedCdpTargets.add(c.cdpTarget));
        }
        if (params.userContexts !== void 0) {
          await __privateGet(this, _userContextStorage).verifyUserContextIdList(params.userContexts);
          params.userContexts.forEach((userContext) => {
            __privateGet(this, _contextConfigStorage).updateUserContextConfig(userContext, {
              extraHeaders: cdpExtraHeaders
            });
            __privateGet(this, _browsingContextStorage).getAllContexts().filter((c) => c.userContext === userContext).forEach((c) => affectedCdpTargets.add(c.cdpTarget));
          });
        }
        if (params.contexts !== void 0) {
          __privateGet(this, _browsingContextStorage).verifyTopLevelContextsList(params.contexts);
          params.contexts.forEach((browsingContextId) => {
            __privateGet(this, _contextConfigStorage).updateBrowsingContextConfig(browsingContextId, { extraHeaders: cdpExtraHeaders });
            affectedCdpTargets.add(__privateGet(this, _browsingContextStorage).getContext(browsingContextId).cdpTarget);
            __privateGet(this, _browsingContextStorage).getContext(browsingContextId).allChildren.forEach((c) => affectedCdpTargets.add(c.cdpTarget));
          });
        }
...
var require_ChannelProxy = __commonJS({
  "node_modules/chromium-bidi/lib/cjs/bidiMapper/modules/script/ChannelProxy.js"(exports) {
    ...
    var _properties2, _id, _logger, _createChannelProxyEvalStr, createChannelProxyEvalStr_fn, _createAndGetHandleInRealm, createAndGetHandleInRealm_fn, _createSendMessageHandle, createSendMessageHandle_fn, _startListener, startListener_fn, _getHandleFromWindow, getHandleFromWindow_fn;
...
var require_PreloadScript = __commonJS({
  "node_modules/chromium-bidi/lib/cjs/bidiMapper/modules/script/PreloadScript.js"(exports) {
    ...
    var _id, _cdpPreloadScripts, _functionDeclaration, _targetIds, _channels, _sandbox, _contexts, _userContexts, _getEvaluateString, getEvaluateString_fn;
    var PreloadScript = class {
      constructor(params, logger) {
        ...
        /** The browsing contexts to execute the preload scripts in, if any. */
        __privateAdd(this, _userContexts, void 0);
        var _a3;
...
var require_ScriptProcessor = __commonJS({
  "node_modules/chromium-bidi/lib/cjs/bidiMapper/modules/script/ScriptProcessor.js"(exports) {
    ...
    var _eventManager, _browsingContextStorage, _realmStorage, _preloadScriptStorage, _userContextStorage, _logger, _onRealmCreatedSubscribeHook, onRealmCreatedSubscribeHook_fn, _getRealm2, getRealm_fn2;
    var ScriptProcessor = class {
      constructor(eventManager, browsingContextStorage, realmStorage, preloadScriptStorage, userContextStorage, logger) {
        __privateAdd(this, _onRealmCreatedSubscribeHook);
        ...
        __privateSet(this, _logger, logger);
        __privateSet(this, _eventManager, eventManager);
        __privateGet(this, _eventManager).addSubscribeHook(protocol_js_1.ChromiumBidi.Script.EventNames.RealmCreated, __privateMethod(this, _onRealmCreatedSubscribeHook, onRealmCreatedSubscribeHook_fn).bind(this));
      }
      ...
      async callFunction(params) {
        const realm = await __privateMethod(this, _getRealm2, getRealm_fn2).call(this, params.target);
    ...
    _userContextStorage = new WeakMap();
    _logger = new WeakMap();
    _onRealmCreatedSubscribeHook = new WeakSet();
...
var require_SessionProcessor = __commonJS({
  "node_modules/chromium-bidi/lib/cjs/bidiMapper/modules/session/SessionProcessor.js"(exports) {
    ...
    var protocol_js_1 = require_protocol();
    var _eventManager, _browserCdpClient, _initConnection, _created, _mergeCapabilities, mergeCapabilities_fn, _getUnhandledPromptBehavior, getUnhandledPromptBehavior_fn;
    var SessionProcessor = class {
      constructor(eventManager, browserCdpClient, initConnection) {
        __privateAdd(this, _mergeCapabilities);
        __privateAdd(this, _getUnhandledPromptBehavior);
        __privateAdd(this, _eventManager, void 0);
        __privateAdd(this, _browserCdpClient, void 0);
        __privateAdd(this, _initConnection, void 0);
      ...
      async new(params) {
        ...
        const matchedCapabitlites = __privateMethod(this, _mergeCapabilities, mergeCapabilities_fn).call(this, params.capabilities);
    ...
    _mergeCapabilities = new WeakSet();
    mergeCapabilities_fn = function(capabilitiesRequest) {
      ...
      match.unhandledPromptBehavior = __privateMethod(this, _getUnhandledPromptBehavior, getUnhandledPromptBehavior_fn).call(this, match.unhandledPromptBehavior);
      return match;
    };
    _getUnhandledPromptBehavior = new WeakSet();
  ...
  "node_modules/chromium-bidi/lib/cjs/bidiMapper/OutgoingMessage.js"(exports) {
    ...
    var _OutgoingMessage = class _OutgoingMessage {
      constructor(message, googChannel = null) {
        ...
        __privateAdd(this, _googChannel, void 0);
...
var require_CommandProcessor = __commonJS({
  "node_modules/chromium-bidi/lib/cjs/bidiMapper/CommandProcessor.js"(exports) {
    ...
    var _bluetoothProcessor, _browserCdpClient, _browserProcessor, _browsingContextProcessor, _cdpProcessor, _emulationProcessor, _inputProcessor, _networkProcessor, _permissionsProcessor, _scriptProcessor, _sessionProcessor, _storageProcessor, _webExtensionProcessor, _parser, _logger, _processCommand, processCommand_fn, _processTargetParams, processTargetParams_fn;
    var CommandProcessor = class extends EventEmitter_js_1.EventEmitter {
      constructor(cdpConnection, browserCdpClient, eventManager, browsingContextStorage, realmStorage, preloadScriptStorage, networkStorage, contextConfigStorage, bluetoothProcessor, userContextStorage, parser = new BidiNoOpParser_js_1.BidiNoOpParser(), initConnection, logger) {
        ...
        // keep-sorted start
        __privateAdd(this, _bluetoothProcessor, void 0);
        __privateAdd(this, _browserCdpClient, void 0);
        ...
        __privateAdd(this, _emulationProcessor, void 0);
        ...
        __privateAdd(this, _webExtensionProcessor, void 0);
        // keep-sorted end
      ...
      async processCommand(command) {
        ...
        try {
          ...
          if (e instanceof protocol_js_1.Exception) {
            ...
            const errorException = __privateGet(this, _browserCdpClient).isCloseError(e) ? new protocol_js_1.NoSuchFrameException(`Browsing context is gone`) : new protocol_js_1.UnknownErrorException(error.message, error.stack);
            this.emit("response", {
...
var require_BluetoothProcessor = __commonJS({
  "node_modules/chromium-bidi/lib/cjs/bidiMapper/modules/bluetooth/BluetoothProcessor.js"(exports) {
    ...
    var _eventManager, _browsingContextStorage, _bluetoothDevices, _bluetoothCharacteristics, _bluetoothDescriptors, _getDevice, getDevice_fn, _getService, getService_fn, _getCharacteristic, getCharacteristic_fn, _getDescriptor, getDescriptor_fn;
    var BluetoothProcessor = class {
      constructor(eventManager, browsingContextStorage) {
        __privateAdd(this, _getDevice);
        __privateAdd(this, _getService);
        __privateAdd(this, _getCharacteristic);
        __privateAdd(this, _getDescriptor);
        __privateAdd(this, _eventManager, void 0);
        __privateAdd(this, _browsingContextStorage, void 0);
      ...
      async simulateCharacteristic(params) {
        const device = __privateMethod(this, _getDevice, getDevice_fn).call(this, params.address);
        const service = __privateMethod(this, _getService, getService_fn).call(this, device, params.serviceUuid);
        const context = __privateGet(this, _browsingContextStorage).getContext(params.context);
        switch (params.type) {
          case "add": {
          ...
          case "remove": {
            ...
            const characteristic = __privateMethod(this, _getCharacteristic, getCharacteristic_fn).call(this, service, params.characteristicUuid);
      ...
      async simulateDescriptor(params) {
        ...
        switch (params.type) {
          ...
          case "remove": {
            const descriptor = __privateMethod(this, _getDescriptor, getDescriptor_fn).call(this, characteristic, params.descriptorUuid);
      ...
      async simulateService(params) {
        ...
        switch (params.type) {
          ...
          case "remove": {
            const service = __privateMethod(this, _getService, getService_fn).call(this, device, params.uuid);
    ...
    _getCharacteristic = new WeakSet();
...
var require_ContextConfigStorage = __commonJS({
  "node_modules/chromium-bidi/lib/cjs/bidiMapper/modules/browser/ContextConfigStorage.js"(exports) {
    ...
    var _global, _userContextConfigs, _browsingContextConfigs;
  ...
  "node_modules/chromium-bidi/lib/cjs/bidiMapper/modules/browser/UserContextStorage.js"(exports) {
    ...
    var UserContextStorage = class {
      constructor(browserClient) {
        __privateAdd(this, _browserClient2, void 0);
...
var require_Deferred = __commonJS({
  "node_modules/chromium-bidi/lib/cjs/utils/Deferred.js"(exports) {
    ...
    var _isFinished, _promise, _result, _resolve, _reject, _a3;
    var Deferred2 = class {
      constructor() {
...
var require_WindowRealm = __commonJS({
  "node_modules/chromium-bidi/lib/cjs/bidiMapper/modules/script/WindowRealm.js"(exports) {
    ...
    var _browsingContextId, _browsingContextStorage, _getBrowsingContextId, getBrowsingContextId_fn;
    ...
    _browsingContextStorage = new WeakMap();
    _getBrowsingContextId = new WeakSet();
...
var require_NavigationTracker = __commonJS({
  "node_modules/chromium-bidi/lib/cjs/bidiMapper/modules/context/NavigationTracker.js"(exports) {
    ...
    var _browsingContextId, _started2, _finished, _isInitial, _eventManager, _finish, finish_fn;
    var NavigationState = class {
      constructor(url, browsingContextId, isInitial, eventManager) {
        ...
        __privateAdd(this, _isInitial, void 0);
        __privateAdd(this, _eventManager, void 0);
      ...
      fragmentNavigated() {
        this.committed.resolve();
        __privateMethod(this, _finish, finish_fn).call(this, new NavigationResult(
      ...
      fail(message) {
        __privateMethod(this, _finish, finish_fn).call(this, new NavigationResult(this.committed.isFinished ? "browsingContext.navigationAborted" : "browsingContext.navigationFailed", message));
      }
    };
    _browsingContextId = new WeakMap();
    ...
    var _eventManager2, _logger, _loaderIdToNavigationsMap, _browsingContextId2, _lastCommittedNavigation, _pendingNavigation, _isInitialNavigation, _getNavigationForFrameNavigated, getNavigationForFrameNavigated_fn, _isFragmentNavigation, isFragmentNavigation_fn;
    var _NavigationTracker = class _NavigationTracker {
      constructor(url, browsingContextId, eventManager, logger) {
        __privateAdd(this, _getNavigationForFrameNavigated);
        __privateAdd(this, _eventManager2, void 0);
        __privateAdd(this, _logger, void 0);
        __privateAdd(this, _loaderIdToNavigationsMap, /* @__PURE__ */ new Map());
        __privateAdd(this, _browsingContextId2, void 0);
        /**
         ...
         */
        __privateAdd(this, _lastCommittedNavigation, void 0);
        /**
         * Pending navigation is a navigation that is started but not yet committed.
         */
        __privateAdd(this, _pendingNavigation, void 0);
      ...
      frameNavigated(url, loaderId, unreachableUrl) {
        ...
        const navigation = __privateMethod(this, _getNavigationForFrameNavigated, getNavigationForFrameNavigated_fn).call(this, url, loaderId);
      ...
      frameStartedNavigating(url, loaderId, navigationType) {
        ...
        if (__privateGet(this, _loaderIdToNavigationsMap).has(loaderId)) {
          ...
          existingNavigation.isFragmentNavigation = __privateMethod(_e = _NavigationTracker, _isFragmentNavigation, isFragmentNavigation_fn).call(_e, navigationType);
        ...
        pendingNavigation.isFragmentNavigation = __privateMethod(_f = _NavigationTracker, _isFragmentNavigation, isFragmentNavigation_fn).call(_f, navigationType);
    ...
    _getNavigationForFrameNavigated = new WeakSet();
...
var require_BrowsingContextImpl = __commonJS({
  "node_modules/chromium-bidi/lib/cjs/bidiMapper/modules/context/BrowsingContextImpl.js"(exports) {
    ...
    var _children, _id, _hiddenSandbox, _downloadIdToUrlMap, _loaderId, _parentId, _originalOpener, _lifecycle, _cdpTarget, _defaultRealmDeferred, _browsingContextStorage, _eventManager, _logger, _navigationTracker, _realmStorage, _configStorage, _lastUserPromptType, _deleteAllChildren, deleteAllChildren_fn, _getOrCreateSandboxInternal, getOrCreateSandboxInternal_fn, _initListeners, initListeners_fn, _getPromptType, getPromptType_fn, _getPromptHandler, getPromptHandler_fn, _documentChanged, documentChanged_fn, _resetLifecycleIfFinished, resetLifecycleIfFinished_fn, _failLifecycleIfNotFinished, failLifecycleIfNotFinished_fn, _waitNavigation, waitNavigation_fn, _parseRect, parseRect_fn, _getLocatorDelegate, getLocatorDelegate_fn, _locateNodesByLocator, locateNodesByLocator_fn, _getAllRelatedCdpTargets, getAllRelatedCdpTargets_fn;
    var BrowsingContextImpl = class {
      constructor(id, parentId, userContext, cdpTarget, eventManager, browsingContextStorage, realmStorage, configStorage, url, originalOpener, logger) {
        ...
        __privateAdd(this, _getOrCreateSandboxInternal);
        ...
        __privateAdd(this, _getAllRelatedCdpTargets);
        ...
        __privateAdd(this, _hiddenSandbox, (0, uuid_js_1.uuidv4)());
        ...
        __privateGet(this, _realmStorage).hiddenSandboxes.add(__privateGet(this, _hiddenSandbox));
      ...
      async getOrCreateHiddenSandbox() {
        return await __privateMethod(this, _getOrCreateSandboxInternal, getOrCreateSandboxInternal_fn).call(this, __privateGet(this, _hiddenSandbox));
      }
      /** Returns a sandbox which is exposed to user. */
      async getOrCreateUserSandbox(sandbox) {
        const realm = await __privateMethod(this, _getOrCreateSandboxInternal, getOrCreateSandboxInternal_fn).call(this, sandbox);
        if (realm.isHidden()) {
      ...
      async setTimezoneOverride(timezone) {
        await Promise.all(__privateMethod(this, _getAllRelatedCdpTargets, getAllRelatedCdpTargets_fn).call(this).map(async (cdpTarget) => await cdpTarget.setTimezoneOverride(timezone)));
      }
      async setLocaleOverride(locale) {
        await Promise.all(__privateMethod(this, _getAllRelatedCdpTargets, getAllRelatedCdpTargets_fn).call(this).map(async (cdpTarget) => await cdpTarget.setLocaleOverride(locale)));
      }
      async setGeolocationOverride(geolocation) {
        await Promise.all(__privateMethod(this, _getAllRelatedCdpTargets, getAllRelatedCdpTargets_fn).call(this).map(async (cdpTarget) => await cdpTarget.setGeolocationOverride(geolocation)));
      }
    ...
    _getOrCreateSandboxInternal = new WeakSet();
    ...
    initListeners_fn = function() {
      ...
      __privateGet(this, _cdpTarget).cdpClient.on("Page.javascriptDialogOpening", (params) => {
        ...
        const promptType = __privateMethod(_b = _a3, _getPromptType, getPromptType_fn).call(_b, params.type);
    ...
    getPromptHandler_fn = function(promptType) {
      ...
      const contextConfig = __privateGet(this, _configStorage).getActiveConfig(this.top.id, this.userContext);
      switch (promptType) {
        case "alert":
          return ((_a4 = contextConfig.userPromptHandler) == null ? void 0 : _a4.alert) ?? ((_b = contextConfig.userPromptHandler) == null ? void 0 : _b.default) ?? defaultPromptHandler;
        case "beforeunload":
          return ((_c = contextConfig.userPromptHandler) == null ? void 0 : _c.beforeUnload) ?? ((_d = contextConfig.userPromptHandler) == null ? void 0 : _d.default) ?? "accept";
        case "confirm":
    ...
    _getAllRelatedCdpTargets = new WeakSet();
...
var require_CdpTarget = __commonJS({
  "node_modules/chromium-bidi/lib/cjs/bidiMapper/modules/cdp/CdpTarget.js"(exports) {
    ...
    var _id, _userContext, _cdpClient, _browserCdpClient, _parentCdpClient, _realmStorage, _eventManager, _preloadScriptStorage, _browsingContextStorage, _networkStorage, _unblocked, _logger, _previousDeviceMetricsOverride, _windowId, _deviceAccessEnabled, _cacheDisableState, _fetchDomainStages, _unblock, unblock_fn, _restoreFrameTreeState, restoreFrameTreeState_fn, _isExpectedError, isExpectedError_fn, _setEventListeners, setEventListeners_fn, _enableFetch, enableFetch_fn, _disableFetch, disableFetch_fn, _updateWindowId, updateWindowId_fn, _initAndEvaluatePreloadScripts, initAndEvaluatePreloadScripts_fn, _setUserContextConfig, setUserContextConfig_fn, _ignoreFileDialog, ignoreFileDialog_fn, _toCdpScreenOrientationAngle, toCdpScreenOrientationAngle_fn;
    var _CdpTarget = class _CdpTarget {
      constructor(targetId, cdpClient, browserCdpClient, parentCdpClient, eventManager, realmStorage, preloadScriptStorage, browsingContextStorage, configStorage, networkStorage, userContext, logger) {
        ...
        __privateAdd(this, _restoreFrameTreeState);
        /**
         * Heuristic checking if the error is due to the session being closed. If so, ignore the
         * error.
         */
        __privateAdd(this, _isExpectedError);
        __privateAdd(this, _setEventListeners);
        __privateAdd(this, _enableFetch);
        __privateAdd(this, _disableFetch);
        __privateAdd(this, _updateWindowId);
         ...
         */
        __privateAdd(this, _setUserContextConfig);
        __privateAdd(this, _ignoreFileDialog);
        __privateAdd(this, _toCdpScreenOrientationAngle);
        __privateAdd(this, _id, void 0);
        __privateAdd(this, _userContext, void 0);
        __privateAdd(this, _cdpClient, void 0);
        __privateAdd(this, _browserCdpClient, void 0);
        __privateAdd(this, _parentCdpClient, void 0);
        __privateAdd(this, _realmStorage, void 0);
        __privateAdd(this, _eventManager, void 0);
        __privateAdd(this, _preloadScriptStorage, void 0);
        __privateAdd(this, _browsingContextStorage, void 0);
         ...
         * */
        __privateAdd(this, _windowId, void 0);
      ...
      async toggleNetworkIfNeeded() {
        ...
        try {
          ...
          (_a3 = __privateGet(this, _logger)) == null ? void 0 : _a3.call(this, log_js_1.LogType.debugError, err);
          if (!__privateMethod(this, _isExpectedError, isExpectedError_fn).call(this, err)) {
            throw err;
          }
        }
      }
      ...
      async toggleNetwork() {
        ...
        if (fetchEnable && fetchChanged) {
          await __privateMethod(this, _enableFetch, enableFetch_fn).call(this, stages);
        }
        if (!fetchEnable && fetchChanged) {
          await __privateMethod(this, _disableFetch, disableFetch_fn).call(this);
        }
      }
      /**
      ...
      async setScreenOrientationOverride(screenOrientation) {
        ...
        if (screenOrientation === null) {
          ...
          newViewport.screenOrientation = __privateMethod(this, _toCdpScreenOrientationAngle, toCdpScreenOrientationAngle_fn).call(this, screenOrientation);
        }
        await this.cdpClient.sendCommand("Emulation.setDeviceMetricsOverride", newViewport);
        __privateSet(this, _previousDeviceMetricsOverride, newViewport);
      }
    ...
    unblock_fn = async function() {
      ...
      try {
        await Promise.all([
          ...
          ...__privateMethod(this, _ignoreFileDialog, ignoreFileDialog_fn).call(this) ? [] : [
          ...
          __privateGet(this, _cdpClient).sendCommand("Page.getFrameTree").then((frameTree) => __privateMethod(this, _restoreFrameTreeState, restoreFrameTreeState_fn).call(this, frameTree.frameTree)),
          ...
          __privateMethod(this, _updateWindowId, updateWindowId_fn).call(this),
          __privateMethod(this, _setUserContextConfig, setUserContextConfig_fn).call(this),
    ...
    _restoreFrameTreeState = new WeakSet();
    restoreFrameTreeState_fn = function(frameTree) {
      ...
      if (maybeContext === void 0 && frame.parentId !== void 0) {
        ...
        BrowsingContextImpl_js_1.BrowsingContextImpl.create(frame.id, frame.parentId, __privateGet(this, _userContext), parentBrowsingContext.cdpTarget, __privateGet(this, _eventManager), __privateGet(this, _browsingContextStorage), __privateGet(this, _realmStorage), this.contextConfigStorage, frame.url, void 0, __privateGet(this, _logger));
      }
      (_a3 = frameTree.childFrames) == null ? void 0 : _a3.map((frameTree2) => __privateMethod(this, _restoreFrameTreeState, restoreFrameTreeState_fn).call(this, frameTree2));
    };
    _isExpectedError = new WeakSet();
    ...
    _setUserContextConfig = new WeakSet();
    setUserContextConfig_fn = async function() {
      ...
      promises.push(__privateGet(this, _cdpClient).sendCommand("Page.setPrerenderingAllowed", {
    ...
    _ignoreFileDialog = new WeakSet();
    ignoreFileDialog_fn = function() {
      var _a3, _b;
      const config = this.contextConfigStorage.getActiveConfig(this.topLevelId, __privateGet(this, _userContext));
      return (((_a3 = config.userPromptHandler) == null ? void 0 : _a3.file) ?? ((_b = config.userPromptHandler) == null ? void 0 : _b.default) ?? "ignore") === "ignore";
    };
    _toCdpScreenOrientationAngle = new WeakSet();
...
var require_CdpTargetManager = __commonJS({
  "node_modules/chromium-bidi/lib/cjs/bidiMapper/modules/cdp/CdpTargetManager.js"(exports) {
    ...
    var _browserCdpClient, _cdpConnection, _targetKeysToBeIgnoredByAutoAttach, _selfTargetId, _eventManager, _browsingContextStorage, _networkStorage, _bluetoothProcessor, _preloadScriptStorage, _realmStorage, _configStorage, _defaultUserContextId, _logger, _setEventListeners, setEventListeners_fn, _handleFrameAttachedEvent, handleFrameAttachedEvent_fn, _handleFrameSubtreeWillBeDetached, handleFrameSubtreeWillBeDetached_fn, _handleAttachedToTargetEvent, handleAttachedToTargetEvent_fn, _findFrameParentId, findFrameParentId_fn, _createCdpTarget, createCdpTarget_fn, _workers4, _handleWorkerTarget, handleWorkerTarget_fn, _handleDetachedFromTargetEvent, handleDetachedFromTargetEvent_fn, _handleTargetInfoChangedEvent, handleTargetInfoChangedEvent_fn, _handleTargetCrashedEvent, handleTargetCrashedEvent_fn;
    ...
    setEventListeners_fn = function(cdpClient) {
      ...
      cdpClient.on("Page.frameSubtreeWillBeDetached", __privateMethod(this, _handleFrameSubtreeWillBeDetached, handleFrameSubtreeWillBeDetached_fn).bind(this));
    };
    ...
    handleFrameAttachedEvent_fn = function(params) {
      ...
      if (parentBrowsingContext !== void 0) {
        BrowsingContextImpl_js_1.BrowsingContextImpl.create(
          ...
          __privateGet(this, _configStorage),
    ...
    _handleFrameSubtreeWillBeDetached = new WeakSet();
    ...
    handleAttachedToTargetEvent_fn = function(params, parentSessionCdpClient) {
      ...
      switch (targetInfo.type) {
        ...
        case "page":
        case "iframe": {
          const cdpTarget = __privateMethod(this, _createCdpTarget, createCdpTarget_fn).call(this, targetCdpClient, parentSessionCdpClient, targetInfo, userContext);
          ...
          if (maybeContext && targetInfo.type === "iframe") {
            ...
            const parentId = __privateMethod(this, _findFrameParentId, findFrameParentId_fn).call(this, targetInfo, parentSessionCdpClient.sessionId);
            BrowsingContextImpl_js_1.BrowsingContextImpl.create(
              targetInfo.targetId,
              parentId,
              userContext,
    ...
    _findFrameParentId = new WeakSet();
    ...
    createCdpTarget_fn = function(targetCdpClient, parentCdpClient, targetInfo, userContext) {
      ...
      const target = CdpTarget_js_1.CdpTarget.create(targetInfo.targetId, targetCdpClient, __privateGet(this, _browserCdpClient), parentCdpClient, __privateGet(this, _realmStorage), __privateGet(this, _eventManager), __privateGet(this, _preloadScriptStorage), __privateGet(this, _browsingContextStorage), __privateGet(this, _networkStorage), __privateGet(this, _configStorage), userContext, __privateGet(this, _logger));
  ...
  "node_modules/chromium-bidi/lib/cjs/bidiMapper/modules/network/NetworkRequest.js"(exports) {
    ...
    var NetworkRequest = class {
      ...
      onResponseReceivedEvent(event) {
        ...
        __privateGet(this, _networkStorage).markRequestCollectedIfNeeded(this);
        __privateMethod(this, _emitEventsIfReady, emitEventsIfReady_fn).call(this);
      }
      onServedFromCache() {
    ...
    context_get = function() {
      ...
      const result = ((_a4 = __privateGet(this, _response2).paused) == null ? void 0 : _a4.frameId) ?? ((_b = __privateGet(this, _request2).info) == null ? void 0 : _b.frameId) ?? ((_c = __privateGet(this, _request2).paused) == null ? void 0 : _c.frameId) ?? ((_d = __privateGet(this, _request2).auth) == null ? void 0 : _d.frameId);
      if (result !== void 0) {
        return result;
      }
      if (((_f = (_e = __privateGet(this, _request2)) == null ? void 0 : _e.info) == null ? void 0 : _f.initiator.type) === "preflight" && ((_h = (_g = __privateGet(this, _request2)) == null ? void 0 : _g.info) == null ? void 0 : _h.initiator.requestId) !== void 0) {
        const maybeInitiator = __privateGet(this, _networkStorage).getRequestById((_j = (_i = __privateGet(this, _request2)) == null ? void 0 : _i.info) == null ? void 0 : _j.initiator.requestId);
        if (maybeInitiator !== void 0) {
          return ((_k = __privateGet(maybeInitiator, _request2).info) == null ? void 0 : _k.frameId) ?? null;
        }
      }
      return null;
    };
    ...
    emitEventsIfReady_fn = function(options = {}) {
      const requestExtraInfoCompleted = (
        // Flush redirects
        options.wasRedirected || options.hasFailed || __privateMethod(this, _isDataUrl, isDataUrl_fn).call(this) || Boolean(__privateGet(this, _request2).extraInfo) || // Requests from cache don't have extra info
      ...
      if (Boolean(__privateGet(this, _response2).info) && responseExtraInfoCompleted && responseInterceptionCompleted) {
        ...
        __privateGet(this, _networkStorage).disposeRequest(this.id);
      }
    };
    ...
    getBeforeRequestEvent_fn = function() {
      ...
      return {
        ...
        params: {
          ...
          initiator: {
            type: __privateMethod(_a4 = _a3, _getInitiator, getInitiator_fn).call(_a4, __privateGet(this, _request2).info.initiator.type),
...
var require_NetworkStorage = __commonJS({
  "node_modules/chromium-bidi/lib/cjs/bidiMapper/modules/network/NetworkStorage.js"(exports) {
    ...
    var NetworkUtils_js_1 = require_NetworkUtils();
    var _browsingContextStorage, _eventManager, _logger, _requests, _intercepts, _collectors, _requestCollectors, _defaultCacheBehavior, _getOrCreateNetworkRequest, getOrCreateNetworkRequest_fn, _getCollectorIdsForRequest, getCollectorIdsForRequest_fn;
    var NetworkStorage = class {
      constructor(eventManager, browsingContextStorage, browserClient, logger) {
        ...
        __privateAdd(this, _getCollectorIdsForRequest);
        __privateAdd(this, _browsingContextStorage, void 0);
        __privateAdd(this, _eventManager, void 0);
        __privateAdd(this, _logger, void 0);
        /**
      ...
      getCollectorsForBrowsingContext(browsingContextId) {
        var _a3, _b, _c;
        if (!__privateGet(this, _browsingContextStorage).hasContext(browsingContextId)) {
          (_a3 = __privateGet(this, _logger)) == null ? void 0 : _a3.call(this, log_js_1.LogType.debugError, "trying to get collector for unknown browsing context");
          return [];
        }
        const userContext = __privateGet(this, _browsingContextStorage).getContext(browsingContextId).userContext;
        const collectors = /* @__PURE__ */ new Set();
        for (const collector of __privateGet(this, _collectors).values()) {
          if ((_b = collector.contexts) == null ? void 0 : _b.includes(browsingContextId)) {
            collectors.add(collector);
          }
          if ((_c = collector.userContexts) == null ? void 0 : _c.includes(userContext)) {
            collectors.add(collector);
          }
      ...
      markRequestCollectedIfNeeded(request) {
        const collectorIds = __privateMethod(this, _getCollectorIdsForRequest, getCollectorIdsForRequest_fn).call(this, request);
    ...
    _getCollectorIdsForRequest = new WeakSet();
    getCollectorIdsForRequest_fn = function(request) {
      ...
      for (const collectorId of __privateGet(this, _collectors).keys()) {
        ...
        if ((_b = collector.userContexts) == null ? void 0 : _b.includes(__privateGet(this, _browsingContextStorage).getContext(request.cdpTarget.topLevelId).userContext)) {
          collectors.add(collectorId);
        }
      }
      (_c = __privateGet(this, _logger)) == null ? void 0 : _c.call(this, log_js_1.LogType.debug, `Request ${request.id} has ${collectors.size} collectors`);
      return [...collectors.values()];
    };
...
var require_SubscriptionManager = __commonJS({
  "node_modules/chromium-bidi/lib/cjs/bidiMapper/modules/session/SubscriptionManager.js"(exports) {
    ...
    var _subscriptions, _knownSubscriptionIds, _browsingContextStorage, _isSubscribedTo, isSubscribedTo_fn;
    var SubscriptionManager = class {
      constructor(browsingContextStorage) {
        __privateAdd(this, _isSubscribedTo);
      ...
      getGoogChannelsSubscribedToEvent(eventName, contextId) {
        ...
        for (const subscription of __privateGet(this, _subscriptions)) {
          if (__privateMethod(this, _isSubscribedTo, isSubscribedTo_fn).call(this, subscription, eventName, contextId)) {
      ...
      getGoogChannelsSubscribedToEventGlobally(eventName) {
        const googChannels = /* @__PURE__ */ new Set();
        for (const subscription of __privateGet(this, _subscriptions)) {
          if (__privateMethod(this, _isSubscribedTo, isSubscribedTo_fn).call(this, subscription, eventName)) {
            googChannels.add(subscription.googChannel);
          }
        }
        return Array.from(googChannels);
      ...
      isSubscribedTo(moduleOrEvent, contextId) {
        for (const subscription of __privateGet(this, _subscriptions)) {
          if (__privateMethod(this, _isSubscribedTo, isSubscribedTo_fn).call(this, subscription, moduleOrEvent, contextId)) {
            return true;
          }
        }
        return false;
  ...
  "node_modules/chromium-bidi/lib/cjs/bidiMapper/modules/session/EventManager.js"(exports) {
    ...
    var EventManager = class extends EventEmitter_js_1.EventEmitter {
      ...
      registerPromiseEvent(event, contextId, eventName) {
        ...
        for (const googChannel of sortedGoogChannels) {
          ...
          __privateMethod(this, _markEventSent, markEventSent_fn).call(this, eventWrapper, googChannel, eventName);
        }
      }
      ...
      async subscribe(eventNames, contextIds, userContextIds, googChannel) {
        ...
        for (const eventName of subscription.eventNames) {
          for (const contextId of subscriptionNavigableIds) {
            for (const eventWrapper of __privateMethod(this, _getBufferedEvents, getBufferedEvents_fn).call(this, eventName, contextId, googChannel)) {
              this.emit("event", {
    ...
    getBufferedEvents_fn = function(eventName, contextId, googChannel) {
      ...
      if (contextId === null) {
        ...
        )).map((_contextId2) => __privateMethod(this, _getBufferedEvents, getBufferedEvents_fn).call(this, eventName, _contextId2, googChannel)).forEach((events) => result.push(...events));
      }
...
var require_BidiServer = __commonJS({
  "node_modules/chromium-bidi/lib/cjs/bidiMapper/BidiServer.js"(exports) {
    ...
    var _messageQueue, _transport2, _commandProcessor, _eventManager, _browsingContextStorage, _realmStorage, _preloadScriptStorage, _bluetoothProcessor, _logger, _handleIncomingMessage, _processOutgoingMessage, _topLevelContextsLoaded, topLevelContextsLoaded_fn;
    var _BidiServer = class _BidiServer extends EventEmitter_js_1.EventEmitter {
      constructor(bidiTransport, cdpConnection, browserCdpClient, selfTargetId, defaultUserContextId, parser, logger) {
        ...
        __privateSet(this, _commandProcessor, new CommandProcessor_js_1.CommandProcessor(cdpConnection, browserCdpClient, __privateGet(this, _eventManager), __privateGet(this, _browsingContextStorage), __privateGet(this, _realmStorage), __privateGet(this, _preloadScriptStorage), networkStorage, contextConfigStorage, __privateGet(this, _bluetoothProcessor), userContextStorage, parser, async (options) => {
          ...
          new CdpTargetManager_js_1.CdpTargetManager(cdpConnection, browserCdpClient, selfTargetId, __privateGet(this, _eventManager), __privateGet(this, _browsingContextStorage), __privateGet(this, _realmStorage), networkStorage, contextConfigStorage, __privateGet(this, _bluetoothProcessor), __privateGet(this, _preloadScriptStorage), defaultUserContextId, logger);
          ...
          await __privateMethod(this, _topLevelContextsLoaded, topLevelContextsLoaded_fn).call(this);
        }, __privateGet(this, _logger)));
...
var Navigation = (() => {
  var _request2, _navigation, _browsingContext, _disposables2, _id, _initialize7, initialize_fn7, _matches, matches_fn, _session, session_get, _a4;
  var _a3;
  ...
  return _a4 = class extends _classSuper {
  ...
  }, _request2 = new WeakMap(), _navigation = new WeakMap(), _browsingContext = new WeakMap(), _disposables2 = new WeakMap(), _id = new WeakMap(), _initialize7 = new WeakSet(), initialize_fn7 = function() {
    ...
    const sessionEmitter = __privateGet(this, _disposables2).use(new EventEmitter(__privateGet(this, _session, session_get)));
...
var _workers, _initialize, initialize_fn;
var _WindowRealm = class _WindowRealm extends Realm2 {
  ...
  static from(context, sandbox) {
    ...
    __privateMethod(_a3 = realm, _initialize, initialize_fn).call(_a3);
    return realm;
  }
  get session() {
...
var _workers2, _initialize2, initialize_fn2;
var DedicatedWorkerRealm = class extends Realm2 {
  ...
  static from(owner, id, origin) {
    ...
    __privateMethod(_a3 = realm, _initialize2, initialize_fn2).call(_a3);
    return realm;
  }
  get session() {
...
var _workers3, _initialize3, initialize_fn3;
var _SharedWorkerRealm = class _SharedWorkerRealm extends Realm2 {
  ...
  static from(browser, id, origin) {
    ...
    __privateMethod(_a3 = realm, _initialize3, initialize_fn3).call(_a3);
    return realm;
  }
  get session() {
...
var Request = (() => {
  var _responseContentPromise, _error, _redirect, _response2, _browsingContext, _disposables2, _event, _initialize7, initialize_fn7, _session, session_get, _a4;
  var _a3;
  let _classSuper = EventEmitter;
  let _instanceExtraInitializers = [];
  let _dispose_decorators;
  return _a4 = class extends _classSuper {
    constructor(browsingContext, event) {
      ...
      __privateAdd(this, _initialize7);
      __privateAdd(this, _session);
      __privateAdd(this, _responseContentPromise, (__runInitializers3(this, _instanceExtraInitializers), null));
    ...
    async getResponseContent() {
      if (!__privateGet(this, _responseContentPromise)) {
        __privateSet(this, _responseContentPromise, (async () => {
          try {
            const data = await __privateGet(this, _session, session_get).send("network.getData", {
              dataType: "response",
              request: this.id
            });
  ...
  }, _responseContentPromise = new WeakMap(), _error = new WeakMap(), _redirect = new WeakMap(), _response2 = new WeakMap(), _browsingContext = new WeakMap(), _disposables2 = new WeakMap(), _event = new WeakMap(), _initialize7 = new WeakSet(), initialize_fn7 = function() {
    const browsingContextEmitter = __privateGet(this, _disposables2).use(new EventEmitter(__privateGet(this, _browsingContext)));
...
var UserPrompt = (() => {
  var _reason, _result, _disposables2, _initialize7, initialize_fn7, _session, session_get, _a3;
  let _classSuper = EventEmitter;
  let _instanceExtraInitializers = [];
  let _dispose_decorators;
  ...
  return _a3 = class extends _classSuper {
    ...
    static from(browsingContext, info) {
      ...
      __privateMethod(_a4 = userPrompt, _initialize7, initialize_fn7).call(_a4);
      return userPrompt;
    }
    get closed() {
      return __privateGet(this, _reason) !== void 0;
...
var BrowsingContext = (() => {
  var _navigation, _reason, _url2, _children, _disposables2, _realms, _requests, _initialize7, initialize_fn7, _session, session_get, _createWindowRealm, createWindowRealm_fn, _a4;
  var _a3;
  let _classSuper = EventEmitter;
  let _instanceExtraInitializers = [];
  let _dispose_decorators;
  ...
  return _a4 = class extends _classSuper {
    ...
    async setCacheBehavior(cacheBehavior) {
      await __privateGet(this, _session, session_get).send("network.setCacheBehavior", {
        contexts: [this.id],
        cacheBehavior
      });
    }
    ...
    async subscribe(events) {
      await __privateGet(this, _session, session_get).subscribe(events, [this.id]);
    }
  ...
  }, _navigation = new WeakMap(), _reason = new WeakMap(), _url2 = new WeakMap(), _children = new WeakMap(), _disposables2 = new WeakMap(), _realms = new WeakMap(), _requests = new WeakMap(), _initialize7 = new WeakSet(), initialize_fn7 = function() {
    ...
    __esDecorate5(_a4, null, _setTimezoneOverride_decorators, { kind: "method", name: "setTimezoneOverride", static: false, private: false, access: { has: (obj) => "setTimezoneOverride" in obj, get: (obj) => obj.setTimezoneOverride }, metadata: _metadata }, null, _instanceExtraInitializers);
...
var UserContext = (() => {
  var _a3, _reason, _browsingContexts, _disposables2, _id, _initialize7, initialize_fn7, _session, session_get;
  let _classSuper = EventEmitter;
  let _instanceExtraInitializers = [];
  let _dispose_decorators;
  ...
  return _a3 = class extends _classSuper {
    ...
    static create(browser, id) {
      ...
      __privateMethod(_a4 = context, _initialize7, initialize_fn7).call(_a4);
      return context;
    }
  ...
  }, _reason = new WeakMap(), _browsingContexts = new WeakMap(), _disposables2 = new WeakMap(), _id = new WeakMap(), _initialize7 = new WeakSet(), initialize_fn7 = function() {
...
var _frame, _apply, _isolate, _channel, _scripts, _disposables, _initialize4, initialize_fn4, _connection2, connection_get, _handleMessage, _getRealm, getRealm_fn, _findFrame, findFrame_fn;
var _ExposableFunction = class _ExposableFunction {
  constructor(frame, name, apply, isolate = false) {
    ...
    __privateAdd(this, _handleMessage, async (params) => {
      ...
      try {
        ...
        const realm = __privateMethod(this, _getRealm, getRealm_fn).call(this, params.source);
        if (!realm) {
          return;
        }
  ...
  static async from(frame, name, apply, isolate = false) {
    ...
    await __privateMethod(_a3 = func, _initialize4, initialize_fn4).call(_a3);
    return func;
  }
  [Symbol.dispose]() {
...
var BidiHTTPResponse = (() => {
  var _data, _request2, _securityDetails, _cdpSupported, _initialize7, initialize_fn7, _a3;
  ...
  return _a3 = class extends _classSuper {
    ...
    static from(data, request, cdpSupported) {
      ...
      __privateMethod(_a4 = response, _initialize7, initialize_fn7).call(_a4);
      return response;
    }
    remoteAddress() {
      return {
    ...
    async content() {
      return await __privateGet(this, _request2).getResponseContent();
    }
  }, _data = new WeakMap(), _request2 = new WeakMap(), _securityDetails = new WeakMap(), _cdpSupported = new WeakMap(), _initialize7 = new WeakSet(), initialize_fn7 = function() {
    var _a4, _b;
...
var _redirectChain, _response, _frame2, _request, _initialize5, initialize_fn5, _hasInternalHeaderOverwrite, hasInternalHeaderOverwrite_get, _extraHTTPHeaders, extraHTTPHeaders_get, _userAgentHeaders, userAgentHeaders_get, _authenticationHandled, _handleAuthentication;
var BidiHTTPRequest = class extends HTTPRequest {
  constructor(request, frame, redirect) {
    ...
    __privateAdd(this, _redirectChain, void 0);
  ...
  static from(bidiRequest, frame, redirect) {
    ...
    __privateMethod(_a3 = request, _initialize5, initialize_fn5).call(_a3);
    return request;
  }
  get client() {
  ...
  getResponseContent() {
    return __privateGet(this, _request).getResponseContent();
  }
};
...
var _frame3, _initialize6, initialize_fn6, _bindingsInstalled;
var _BidiFrameRealm = class _BidiFrameRealm extends BidiRealm {
  ...
  static from(realm, frame) {
    ...
    __privateMethod(_a3 = frameRealm, _initialize6, initialize_fn6).call(_a3);
    return frameRealm;
  }
  get puppeteerUtil() {
...
var BidiFrame = (() => {
  ...
  return _a4 = class extends _classSuper {
    ...
    async waitForNavigation(options = {}) {
      ...
      return await firstValueFrom(combineLatest([
        race(fromEmitterEvent(this.browsingContext, "navigation"), fromEmitterEvent(this.browsingContext, "historyUpdated").pipe(map(() => {
          ...
          return __privateGet(this, _waitForLoad$, waitForLoad$_get).call(this, options).pipe(delayWhen(() => {
            if (frames.length === 0) {
              return of(void 0);
            }
      ...
      }), raceWith(timeout(ms), fromAbortSignal(signal), __privateMethod(this, _detached$, detached$_fn).call(this).pipe(map(() => {
    ...
    __esDecorate9(_a4, _private_waitForLoad$_descriptor = { value: __setFunctionName(function(options = {}) {
      ...
      }), first(), raceWith(timeout(ms), __privateMethod(this, _detached$, detached$_fn).call(this).pipe(map(() => {
...
var BidiTouchHandle = class {
  constructor(page, touchScreen, id, x, y, properties) {
    ...
    __privateAdd(this, _bidiId, void 0);
...
var BidiPage = (() => {
  var _trustedEmitter_accessor_storage, _browserContext, _frame6, _viewport, _workers4, _cdpEmulationManager, _emulatedNetworkConditions, _fileChooserDeferreds, _initialize7, initialize_fn7, _userAgentInterception, _userAgentPreloadScript, _userInterception, _extraHeadersInterception, _authInterception, _toggleInterception, toggleInterception_fn, _applyNetworkConditions, applyNetworkConditions_fn, _go, go_fn, _a3;
  ...
  return _a3 = class extends _classSuper {
    ...
    static from(browserContext, browsingContext) {
      ...
      __privateMethod(_a4 = page, _initialize7, initialize_fn7).call(_a4);
      return page;
    }
    get trustedEmitter() {
    ...
    async setOfflineMode(enabled) {
      ...
      return await __privateMethod(this, _applyNetworkConditions, applyNetworkConditions_fn).call(this);
    }
  ...
  }, _trustedEmitter_accessor_storage = new WeakMap(), _browserContext = new WeakMap(), _frame6 = new WeakMap(), _viewport = new WeakMap(), _workers4 = new WeakMap(), _cdpEmulationManager = new WeakMap(), _emulatedNetworkConditions = new WeakMap(), _fileChooserDeferreds = new WeakMap(), _initialize7 = new WeakSet(), initialize_fn7 = function() {
    ...
    return interception;
  }, _applyNetworkConditions = new WeakSet(), applyNetworkConditions_fn = async function() {
    if (!__privateGet(this, _emulatedNetworkConditions)) {
      return;
    }
...
var BidiFrameTarget = class extends Target {
  constructor(frame) {
    ...
    __privateAdd(this, _page6, void 0);
...
var BidiBrowserContext = (() => {
  var _trustedEmitter_accessor_storage, _browser2, _defaultViewport, _pages, _targets, _overrides, _initialize7, initialize_fn7, _createPage, createPage_fn, _a3;
  ...
  return _a3 = class extends _classSuper {
    ...
    this.userContext.on("browsingcontext", ({ browsingContext }) => {
      const page = __privateMethod(this, _createPage, createPage_fn).call(this, browsingContext);
...
var Browser2 = (() => {
  var _closed3, _reason, _disposables2, _userContexts, _sharedWorkers, _initialize7, initialize_fn7, _syncUserContexts, syncUserContexts_fn, _syncBrowsingContexts, syncBrowsingContexts_fn, _createUserContext, createUserContext_fn, _a3;
  let _classSuper = EventEmitter;
  let _instanceExtraInitializers = [];
  let _dispose_decorators;
  let _close_decorators;
  ...
  return _a3 = class extends _classSuper {
    ...
    static async from(session) {
      ...
      await __privateMethod(_a4 = browser, _initialize7, initialize_fn7).call(_a4);
      return browser;
    }
    get closed() {
...
var Session = (() => {
  var _reason, _disposables2, _info, _connection_accessor_storage, _initialize7, initialize_fn7, _a3;
  let _classSuper = EventEmitter;
  let _instanceExtraInitializers = [];
  ...
  return _a3 = class extends _classSuper {
    ...
    static async from(connection, capabilities) {
      ...
      await __privateMethod(_a4 = session, _initialize7, initialize_fn7).call(_a4);
      return session;
    }
    get connection() {
...
var BidiBrowser = (() => {
  var _a3, _trustedEmitter_accessor_storage, _trustedEmitter, trustedEmitter_get, trustedEmitter_set, _process, _closeCallback, _browserCore, _defaultViewport, _browserContexts, _target, _cdpConnection, _networkEnabled, _initialize7, initialize_fn7, _browserName, browserName_get, _browserVersion, browserVersion_get, _createBrowserContext, createBrowserContext_fn;
  ...
  return _a3 = class extends _classSuper {
    constructor(browserCore, opts) {
      ...
      __privateAdd(this, _cdpConnection, void 0);
      __privateAdd(this, _networkEnabled, void 0);
    ...
    static async create(opts) {
      ...
      __privateMethod(_c = browser, _initialize7, initialize_fn7).call(_c);
      return browser;
    }
    get cdpSupported() {
  ...
  }, _process = new WeakMap(), _closeCallback = new WeakMap(), _browserCore = new WeakMap(), _defaultViewport = new WeakMap(), _browserContexts = new WeakMap(), _target = new WeakMap(), _cdpConnection = new WeakMap(), _networkEnabled = new WeakMap(), _initialize7 = new WeakSet(), initialize_fn7 = function() {
    var _a4;
...
puppeteer-core/lib/esm/puppeteer/bidi/bidi.js:
   ...
   *)
*/
//# sourceMappingURL=bidi-5B2LPEPK.js.map
