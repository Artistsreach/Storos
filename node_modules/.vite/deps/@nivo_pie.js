...
function b2() {
  return b2 = Object.assign ? Object.assign.bind() : function(n2) {
    for (var t2 = 1; t2 < arguments.length; t2++) {
      var e2 = arguments[t2];
      for (var r2 in e2)
        ({}).hasOwnProperty.call(e2, r2) && (n2[r2] = e2[r2]);
    }
    return n2;
...
var sn = function(n2, t2, e2, r2, i2, a3) {
  ...
  var s2 = ft(ut(i2), e2);
  o2.push([s2.x, s2.y]);
  for (var l2 = Math.round(Math.min(r2, i2)); l2 <= Math.round(Math.max(r2, i2)); l2++)
    if (l2 % 90 == 0) {
      var d4 = ft(ut(l2), e2);
      o2.push([d4.x, d4.y]);
    }
...
function E3() {
  return E3 = Object.assign ? Object.assign.bind() : function(e2) {
    for (var i2 = 1; i2 < arguments.length; i2++) {
      var t2 = arguments[i2];
      for (var a3 in t2)
        ({}).hasOwnProperty.call(t2, a3) && (e2[a3] = t2[a3]);
    }
    return e2;
