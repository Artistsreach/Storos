...
var SuppressedError2 = class extends Error {
  constructor(error, suppressed, message = "An error was suppressed during disposal") {
    ...
    __privateAdd(this, _suppressed, void 0);
    this.name = "SuppressedError";
    __privateSet(this, _error, error);
    __privateSet(this, _suppressed, suppressed);
  }
  /**
   ...
   */
  get suppressed() {
    return __privateGet(this, _suppressed);
  }
};
_error = new WeakMap();
...
async function importDebug() {
  if (!debugModule) {
    debugModule = (await import("./browser-KQ7F44CF.js")).default;
  }
  return debugModule;
}
var debug = (prefix) => {
...
function retry(configOrCount) {
  ...
  var _a4 = config2.count, count = _a4 === void 0 ? Infinity : _a4, delay2 = config2.delay, _b = config2.resetOnSuccess, resetOnSuccess = _b === void 0 ? false : _b;
...
var _mutex, _onRelease, _a3, _locked, _acquirers;
...
__publicField(_Mutex, "Guard", (_a3 = class {
  constructor(mutex, onRelease) {
    ...
    __privateAdd(this, _onRelease, void 0);
    __privateSet(this, _mutex, mutex);
    __privateSet(this, _onRelease, onRelease);
  }
  [disposeSymbol]() {
    var _a4;
    (_a4 = __privateGet(this, _onRelease)) == null ? void 0 : _a4.call(this);
    return __privateGet(this, _mutex).release();
  }
}, _mutex = new WeakMap(), _onRelease = new WeakMap(), _a3));
var Mutex = _Mutex;

// node_modules/puppeteer-core/lib/esm/puppeteer/api/BrowserContext.js
var _pageScreenshotMutex, _screenshotOperationsCount;
var BrowserContext = class extends EventEmitter {
  ...
  constructor() {
     ...
     */
    __privateAdd(this, _pageScreenshotMutex, void 0);
   ...
   */
  startScreenshot() {
    const mutex = __privateGet(this, _pageScreenshotMutex) || new Mutex();
  ...
  waitForScreenshotOperations() {
    var _a4;
    return (_a4 = __privateGet(this, _pageScreenshotMutex)) == null ? void 0 : _a4.acquire();
  }
  /**
   * Waits until a {@link Target | target} matching the given `predicate`
   * appears and returns it.
...
_pageScreenshotMutex = new WeakMap();
_screenshotOperationsCount = new WeakMap();
...
var _type, _message, _defaultValue;
var Dialog = class {
  /**
   * @internal
   */
...
var __disposeResources = function(SuppressedError3) {
  return function(env) {
    function fail(e) {
...
var __disposeResources2 = function(SuppressedError3) {
  return function(env) {
    function fail(e) {
      env.error = env.hasError ? new SuppressedError3(e, env.error, "An error was suppressed during disposal.") : e;
      env.hasError = true;
...
var CustomQueryHandlerRegistry = class {
  ...
  register(name, handler) {
    var _a4;
    assert(!__privateGet(this, _handlers2).has(name), `Cannot register over existing handler: ${name}`);
    ...
    const Handler = (_a4 = class extends QueryHandler {
    }, __publicField(_a4, "querySelectorAll", interpolateFunction((node, selector, PuppeteerUtil) => {
      return PuppeteerUtil.customQuerySelectors.get(PLACEHOLDER("name")).querySelectorAll(node, selector);
    }, { name: JSON.stringify(name) })), __publicField(_a4, "querySelector", interpolateFunction((node, selector, PuppeteerUtil) => {
      return PuppeteerUtil.customQuerySelectors.get(PLACEHOLDER("name")).querySelector(node, selector);
    }, { name: JSON.stringify(name) })), _a4);
...
var __disposeResources3 = function(SuppressedError3) {
  return function(env) {
    function fail(e) {
      env.error = env.hasError ? new SuppressedError3(e, env.error, "An error was suppressed during disposal.") : e;
      env.hasError = true;
...
var __disposeResources4 = function(SuppressedError3) {
  return function(env) {
    function fail(e) {
      env.error = env.hasError ? new SuppressedError3(e, env.error, "An error was suppressed during disposal.") : e;
      env.hasError = true;
...
var JSHandle = (() => {
  ...
  var JSHandle2 = (_a4 = class {
    ...
    async getProperties() {
      const propertyNames = await this.evaluate((object) => {
        ...
        for (const propertyName in descriptors) {
          if ((_a5 = descriptors[propertyName]) == null ? void 0 : _a5.enumerable) {
    ...
    __esDecorate(_a4, null, _getProperty_decorators, { kind: "method", name: "getProperty", static: false, private: false, access: { has: (obj) => "getProperty" in obj, get: (obj) => obj.getProperty }, metadata: _metadata }, null, _instanceExtraInitializers);
    __esDecorate(_a4, null, _getProperties_decorators, { kind: "method", name: "getProperties", static: false, private: false, access: { has: (obj) => "getProperties" in obj, get: (obj) => obj.getProperties }, metadata: _metadata }, null, _instanceExtraInitializers);
...
var __disposeResources5 = function(SuppressedError3) {
  return function(env) {
    function fail(e) {
      env.error = env.hasError ? new SuppressedError3(e, env.error, "An error was suppressed during disposal.") : e;
      env.hasError = true;
...
var ElementHandle = (() => {
  ...
  return _a4 = class extends _classSuper {
    ...
    async dispose() {
      var _a5;
      await Promise.all([this.handle.dispose(), (_a5 = this.isolatedHandle) == null ? void 0 : _a5.dispose()]);
    }
    /**
     * @internal
     */
    ...
    async $$(selector, options) {
      if ((options == null ? void 0 : options.isolate) === false) {
        return await __privateMethod(this, _$$impl, $$impl_fn).call(this, selector);
      }
      return await __privateGet(this, _$$, $$_get).call(this, selector);
    }
    /**
    ...
    async isIntersectingViewport(options = {}) {
      ...
      try {
        ...
        const target = __addDisposableResource5(env_5, handle && await __privateMethod(_a5 = handle, _getOwnerSVGElement, getOwnerSVGElement_fn).call(_a5), false);
  ...
  }, _$$ = new WeakSet(), $$_get = function() {
    return _private_$$_descriptor.value;
  }, _$$impl = new WeakSet(), $$impl_fn = async function(selector) {
    const { updatedSelector, QueryHandler: QueryHandler2 } = getQueryHandlerAndSelector(selector);
    ...
    __esDecorate2(_a4, null, _getProperty_decorators, { kind: "method", name: "getProperty", static: false, private: false, access: { has: (obj) => "getProperty" in obj, get: (obj) => obj.getProperty }, metadata: _metadata }, null, _instanceExtraInitializers);
    __esDecorate2(_a4, null, _getProperties_decorators, { kind: "method", name: "getProperties", static: false, private: false, access: { has: (obj) => "getProperties" in obj, get: (obj) => obj.getProperties }, metadata: _metadata }, null, _instanceExtraInitializers);
    __esDecorate2(_a4, null, _jsonValue_decorators, { kind: "method", name: "jsonValue", static: false, private: false, access: { has: (obj) => "jsonValue" in obj, get: (obj) => obj.jsonValue }, metadata: _metadata }, null, _instanceExtraInitializers);
    __esDecorate2(_a4, null, _$_decorators, { kind: "method", name: "$", static: false, private: false, access: { has: (obj) => "$" in obj, get: (obj) => obj.$ }, metadata: _metadata }, null, _instanceExtraInitializers);
    __esDecorate2(_a4, null, _$$_decorators, { kind: "method", name: "$$", static: false, private: false, access: { has: (obj) => "$$" in obj, get: (obj) => obj.$$ }, metadata: _metadata }, null, _instanceExtraInitializers);
    __esDecorate2(_a4, _private_$$_descriptor = { value: __setFunctionName(async function(selector) {
      return await __privateMethod(this, _$$impl, $$impl_fn).call(this, selector);
    }, "#$$") }, _private_$$_decorators, { kind: "method", name: "#$$", static: false, private: true, access: { has: (obj) => __privateIn(_$$, obj), get: (obj) => __privateGet(obj, _$$, $$_get) }, metadata: _metadata }, null, _instanceExtraInitializers);
    __esDecorate2(_a4, null, _waitForSelector_decorators, { kind: "method", name: "waitForSelector", static: false, private: false, access: { has: (obj) => "waitForSelector" in obj, get: (obj) => obj.waitForSelector }, metadata: _metadata }, null, _instanceExtraInitializers);
    __esDecorate2(_a4, null, _isVisible_decorators, { kind: "method", name: "isVisible", static: false, private: false, access: { has: (obj) => "isVisible" in obj, get: (obj) => obj.isVisible }, metadata: _metadata }, null, _instanceExtraInitializers);
    __esDecorate2(_a4, null, _isHidden_decorators, { kind: "method", name: "isHidden", static: false, private: false, access: { has: (obj) => "isHidden" in obj, get: (obj) => obj.isHidden }, metadata: _metadata }, null, _instanceExtraInitializers);
    __esDecorate2(_a4, null, _toElement_decorators, { kind: "method", name: "toElement", static: false, private: false, access: { has: (obj) => "toElement" in obj, get: (obj) => obj.toElement }, metadata: _metadata }, null, _instanceExtraInitializers);
    __esDecorate2(_a4, null, _clickablePoint_decorators, { kind: "method", name: "clickablePoint", static: false, private: false, access: { has: (obj) => "clickablePoint" in obj, get: (obj) => obj.clickablePoint }, metadata: _metadata }, null, _instanceExtraInitializers);
    __esDecorate2(_a4, null, _hover_decorators, { kind: "method", name: "hover", static: false, private: false, access: { has: (obj) => "hover" in obj, get: (obj) => obj.hover }, metadata: _metadata }, null, _instanceExtraInitializers);
    __esDecorate2(_a4, null, _click_decorators, { kind: "method", name: "click", static: false, private: false, access: { has: (obj) => "click" in obj, get: (obj) => obj.click }, metadata: _metadata }, null, _instanceExtraInitializers);
    __esDecorate2(_a4, null, _drag_decorators, { kind: "method", name: "drag", static: false, private: false, access: { has: (obj) => "drag" in obj, get: (obj) => obj.drag }, metadata: _metadata }, null, _instanceExtraInitializers);
    __esDecorate2(_a4, null, _dragEnter_decorators, { kind: "method", name: "dragEnter", static: false, private: false, access: { has: (obj) => "dragEnter" in obj, get: (obj) => obj.dragEnter }, metadata: _metadata }, null, _instanceExtraInitializers);
    __esDecorate2(_a4, null, _dragOver_decorators, { kind: "method", name: "dragOver", static: false, private: false, access: { has: (obj) => "dragOver" in obj, get: (obj) => obj.dragOver }, metadata: _metadata }, null, _instanceExtraInitializers);
    __esDecorate2(_a4, null, _drop_decorators, { kind: "method", name: "drop", static: false, private: false, access: { has: (obj) => "drop" in obj, get: (obj) => obj.drop }, metadata: _metadata }, null, _instanceExtraInitializers);
    __esDecorate2(_a4, null, _dragAndDrop_decorators, { kind: "method", name: "dragAndDrop", static: false, private: false, access: { has: (obj) => "dragAndDrop" in obj, get: (obj) => obj.dragAndDrop }, metadata: _metadata }, null, _instanceExtraInitializers);
    __esDecorate2(_a4, null, _select_decorators, { kind: "method", name: "select", static: false, private: false, access: { has: (obj) => "select" in obj, get: (obj) => obj.select }, metadata: _metadata }, null, _instanceExtraInitializers);
    __esDecorate2(_a4, null, _tap_decorators, { kind: "method", name: "tap", static: false, private: false, access: { has: (obj) => "tap" in obj, get: (obj) => obj.tap }, metadata: _metadata }, null, _instanceExtraInitializers);
    __esDecorate2(_a4, null, _touchStart_decorators, { kind: "method", name: "touchStart", static: false, private: false, access: { has: (obj) => "touchStart" in obj, get: (obj) => obj.touchStart }, metadata: _metadata }, null, _instanceExtraInitializers);
    __esDecorate2(_a4, null, _touchMove_decorators, { kind: "method", name: "touchMove", static: false, private: false, access: { has: (obj) => "touchMove" in obj, get: (obj) => obj.touchMove }, metadata: _metadata }, null, _instanceExtraInitializers);
    __esDecorate2(_a4, null, _touchEnd_decorators, { kind: "method", name: "touchEnd", static: false, private: false, access: { has: (obj) => "touchEnd" in obj, get: (obj) => obj.touchEnd }, metadata: _metadata }, null, _instanceExtraInitializers);
    __esDecorate2(_a4, null, _focus_decorators, { kind: "method", name: "focus", static: false, private: false, access: { has: (obj) => "focus" in obj, get: (obj) => obj.focus }, metadata: _metadata }, null, _instanceExtraInitializers);
    __esDecorate2(_a4, null, _type_decorators, { kind: "method", name: "type", static: false, private: false, access: { has: (obj) => "type" in obj, get: (obj) => obj.type }, metadata: _metadata }, null, _instanceExtraInitializers);
    __esDecorate2(_a4, null, _press_decorators, { kind: "method", name: "press", static: false, private: false, access: { has: (obj) => "press" in obj, get: (obj) => obj.press }, metadata: _metadata }, null, _instanceExtraInitializers);
    __esDecorate2(_a4, null, _boundingBox_decorators, { kind: "method", name: "boundingBox", static: false, private: false, access: { has: (obj) => "boundingBox" in obj, get: (obj) => obj.boundingBox }, metadata: _metadata }, null, _instanceExtraInitializers);
    __esDecorate2(_a4, null, _boxModel_decorators, { kind: "method", name: "boxModel", static: false, private: false, access: { has: (obj) => "boxModel" in obj, get: (obj) => obj.boxModel }, metadata: _metadata }, null, _instanceExtraInitializers);
    __esDecorate2(_a4, null, _screenshot_decorators, { kind: "method", name: "screenshot", static: false, private: false, access: { has: (obj) => "screenshot" in obj, get: (obj) => obj.screenshot }, metadata: _metadata }, null, _instanceExtraInitializers);
    __esDecorate2(_a4, null, _isIntersectingViewport_decorators, { kind: "method", name: "isIntersectingViewport", static: false, private: false, access: { has: (obj) => "isIntersectingViewport" in obj, get: (obj) => obj.isIntersectingViewport }, metadata: _metadata }, null, _instanceExtraInitializers);
    __esDecorate2(_a4, null, _scrollIntoView_decorators, { kind: "method", name: "scrollIntoView", static: false, private: false, access: { has: (obj) => "scrollIntoView" in obj, get: (obj) => obj.scrollIntoView }, metadata: _metadata }, null, _instanceExtraInitializers);
    if (_metadata)
...
var __disposeResources6 = function(SuppressedError3) {
  return function(env) {
    function fail(e) {
      env.error = env.hasError ? new SuppressedError3(e, env.error, "An error was suppressed during disposal.") : e;
      env.hasError = true;
...
var __disposeResources7 = function(SuppressedError3) {
  return function(env) {
    function fail(e) {
      env.error = env.hasError ? new SuppressedError3(e, env.error, "An error was suppressed during disposal.") : e;
      env.hasError = true;
...
var Frame = (() => {
  var __document, _document, document_fn, _a4;
  ...
  return _a4 = class extends _classSuper {
    ...
    __esDecorate3(_a4, null, _frameElement_decorators, { kind: "method", name: "frameElement", static: false, private: false, access: { has: (obj) => "frameElement" in obj, get: (obj) => obj.frameElement }, metadata: _metadata }, null, _instanceExtraInitializers);
    __esDecorate3(_a4, null, _evaluateHandle_decorators, { kind: "method", name: "evaluateHandle", static: false, private: false, access: { has: (obj) => "evaluateHandle" in obj, get: (obj) => obj.evaluateHandle }, metadata: _metadata }, null, _instanceExtraInitializers);
    __esDecorate3(_a4, null, _evaluate_decorators, { kind: "method", name: "evaluate", static: false, private: false, access: { has: (obj) => "evaluate" in obj, get: (obj) => obj.evaluate }, metadata: _metadata }, null, _instanceExtraInitializers);
    __esDecorate3(_a4, null, _locator_decorators, { kind: "method", name: "locator", static: false, private: false, access: { has: (obj) => "locator" in obj, get: (obj) => obj.locator }, metadata: _metadata }, null, _instanceExtraInitializers);
    __esDecorate3(_a4, null, _$_decorators, { kind: "method", name: "$", static: false, private: false, access: { has: (obj) => "$" in obj, get: (obj) => obj.$ }, metadata: _metadata }, null, _instanceExtraInitializers);
    __esDecorate3(_a4, null, _$$_decorators, { kind: "method", name: "$$", static: false, private: false, access: { has: (obj) => "$$" in obj, get: (obj) => obj.$$ }, metadata: _metadata }, null, _instanceExtraInitializers);
    __esDecorate3(_a4, null, _$eval_decorators, { kind: "method", name: "$eval", static: false, private: false, access: { has: (obj) => "$eval" in obj, get: (obj) => obj.$eval }, metadata: _metadata }, null, _instanceExtraInitializers);
    __esDecorate3(_a4, null, _$$eval_decorators, { kind: "method", name: "$$eval", static: false, private: false, access: { has: (obj) => "$$eval" in obj, get: (obj) => obj.$$eval }, metadata: _metadata }, null, _instanceExtraInitializers);
    __esDecorate3(_a4, null, _waitForSelector_decorators, { kind: "method", name: "waitForSelector", static: false, private: false, access: { has: (obj) => "waitForSelector" in obj, get: (obj) => obj.waitForSelector }, metadata: _metadata }, null, _instanceExtraInitializers);
    __esDecorate3(_a4, null, _waitForFunction_decorators, { kind: "method", name: "waitForFunction", static: false, private: false, access: { has: (obj) => "waitForFunction" in obj, get: (obj) => obj.waitForFunction }, metadata: _metadata }, null, _instanceExtraInitializers);
    __esDecorate3(_a4, null, _content_decorators, { kind: "method", name: "content", static: false, private: false, access: { has: (obj) => "content" in obj, get: (obj) => obj.content }, metadata: _metadata }, null, _instanceExtraInitializers);
    __esDecorate3(_a4, null, _addScriptTag_decorators, { kind: "method", name: "addScriptTag", static: false, private: false, access: { has: (obj) => "addScriptTag" in obj, get: (obj) => obj.addScriptTag }, metadata: _metadata }, null, _instanceExtraInitializers);
    __esDecorate3(_a4, null, _addStyleTag_decorators, { kind: "method", name: "addStyleTag", static: false, private: false, access: { has: (obj) => "addStyleTag" in obj, get: (obj) => obj.addStyleTag }, metadata: _metadata }, null, _instanceExtraInitializers);
    __esDecorate3(_a4, null, _click_decorators, { kind: "method", name: "click", static: false, private: false, access: { has: (obj) => "click" in obj, get: (obj) => obj.click }, metadata: _metadata }, null, _instanceExtraInitializers);
    __esDecorate3(_a4, null, _focus_decorators, { kind: "method", name: "focus", static: false, private: false, access: { has: (obj) => "focus" in obj, get: (obj) => obj.focus }, metadata: _metadata }, null, _instanceExtraInitializers);
    __esDecorate3(_a4, null, _hover_decorators, { kind: "method", name: "hover", static: false, private: false, access: { has: (obj) => "hover" in obj, get: (obj) => obj.hover }, metadata: _metadata }, null, _instanceExtraInitializers);
    __esDecorate3(_a4, null, _select_decorators, { kind: "method", name: "select", static: false, private: false, access: { has: (obj) => "select" in obj, get: (obj) => obj.select }, metadata: _metadata }, null, _instanceExtraInitializers);
    __esDecorate3(_a4, null, _tap_decorators, { kind: "method", name: "tap", static: false, private: false, access: { has: (obj) => "tap" in obj, get: (obj) => obj.tap }, metadata: _metadata }, null, _instanceExtraInitializers);
    __esDecorate3(_a4, null, _type_decorators, { kind: "method", name: "type", static: false, private: false, access: { has: (obj) => "type" in obj, get: (obj) => obj.type }, metadata: _metadata }, null, _instanceExtraInitializers);
    __esDecorate3(_a4, null, _title_decorators, { kind: "method", name: "title", static: false, private: false, access: { has: (obj) => "title" in obj, get: (obj) => obj.title }, metadata: _metadata }, null, _instanceExtraInitializers);
    if (_metadata)
      Object.defineProperty(_a4, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
  })(), _a4;
})();
...
var _canBeIntercepted, canBeIntercepted_fn;
var HTTPRequest = class {
  /**
   * @internal
   */
  constructor() {
    __privateAdd(this, _canBeIntercepted);
    /**
     * @internal
     */
  ...
  async continue(overrides = {}, priority) {
    if (!__privateMethod(this, _canBeIntercepted, canBeIntercepted_fn).call(this)) {
      return;
    }
    assert(this.interception.enabled, "Request Interception is not enabled!");
...
var __disposeResources8 = function(SuppressedError3) {
  return function(env) {
    function fail(e) {
      env.error = env.hasError ? new SuppressedError3(e, env.error, "An error was suppressed during disposal.") : e;
      env.hasError = true;
...
var Page = (() => {
  var _requestHandlers, _inflight$, _screencastSessionCount, _startScreencastPromise, _getNativePixelDimensions, getNativePixelDimensions_fn, _a4;
  let _classSuper = EventEmitter;
  let _instanceExtraInitializers = [];
  let _screenshot_decorators;
  return _a4 = class extends _classSuper {
    ...
    waitForNetworkIdle$(options = {}) {
      ...
      return __privateGet(this, _inflight$).pipe(map((inflight) => {
    ...
    async screencast(options = {}) {
      ...
      const [width, height, devicePixelRatio] = await __privateMethod(this, _getNativePixelDimensions, getNativePixelDimensions_fn).call(this);
      let crop;
      if (options.crop) {
    ...
    const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
    __esDecorate4(_a4, null, _screenshot_decorators, { kind: "method", name: "screenshot", static: false, private: false, access: { has: (obj) => "screenshot" in obj, get: (obj) => obj.screenshot }, metadata: _metadata }, null, _instanceExtraInitializers);
    if (_metadata)
      Object.defineProperty(_a4, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
  })(), _a4;
})();
...
var _world, _polling, _root, _fn, _args, _timeout, _genericError, _timeoutError2, _result, _poller, _signal, _reruns, _onAbortSignal;
var WaitTask = class {
  constructor(world, options, fn, ...args) {
    ...
    __privateAdd(this, _genericError, new Error("Waiting failed"));
    ...
    (_a4 = __privateGet(this, _signal)) == null ? void 0 : _a4.addEventListener("abort", __privateGet(this, _onAbortSignal), {
      once: true
    });
    switch (typeof fn) {
      case "string":
  ...
  async rerun() {
    ...
    try {
      ...
      if (badError) {
        __privateGet(this, _genericError).cause = badError;
        await this.terminate(__privateGet(this, _genericError));
      }
    }
  }
  async terminate(error) {
    ...
    (_a4 = __privateGet(this, _signal)) == null ? void 0 : _a4.removeEventListener("abort", __privateGet(this, _onAbortSignal));
...
var __disposeResources9 = function(SuppressedError3) {
  return function(env) {
    function fail(e) {
      env.error = env.hasError ? new SuppressedError3(e, env.error, "An error was suppressed during disposal.") : e;
      env.hasError = true;
...
var Accessibility = class {
  ...
  constructor(realm, frameId = "") {
    ...
    __privateAdd(this, _frameId, void 0);
  ...
  async snapshot(options = {}) {
    ...
    const populateIframes = async (root2) => {
      var _a4;
      if (((_a4 = root2.payload.role) == null ? void 0 : _a4.value) === "Iframe") {
        const env_1 = { stack: [], error: void 0, hasError: false };
        try {
          if (!root2.payload.backendDOMNodeId) {
            return;
          }
          const handle = __addDisposableResource9(env_1, await __privateGet(this, _realm).adoptBackendNode(root2.payload.backendDOMNodeId), false);
...
var _richlyEditable, _editable, _focusable, _hidden, _name, _role, _ignored, _cachedHasFocusableChild, _realm2, _isPlainTextField, isPlainTextField_fn, _isTextOnlyObject, isTextOnlyObject_fn, _hasFocusableChild, hasFocusableChild_fn;
var _AXNode = class _AXNode {
  constructor(realm, payload) {
    ...
    __privateAdd(this, _realm2, void 0);
...
hasFocusableChild_fn = function() {
  ...
  if (__privateGet(this, _cachedHasFocusableChild) === void 0) {
    ...
    for (const child of this.children) {
      if (__privateGet(child, _focusable) || __privateMethod(_a4 = child, _hasFocusableChild, hasFocusableChild_fn).call(_a4)) {
...
var _type2, _text, _args2, _stackTraceLocations, _frame;
...
var _element, _multiple, _handled;
var FileChooser = class {
  ...
  constructor(element, multiple) {
    ...
    __privateSet(this, _multiple, multiple);
  }
  /**
   ...
   */
  async accept(paths) {
    assert(!__privateGet(this, _handled), "Cannot accept FileChooser which is already handled!");
   ...
   */
  async cancel() {
    assert(!__privateGet(this, _handled), "Cannot cancel FileChooser which is already handled!");
    __privateSet(this, _handled, true);
...
var CallbackRegistry = class {
  constructor() {
    ...
    __privateAdd(this, _idGenerator, idGenerator);
  }
...
var _id, _error2, _deferred, _timer, _label;
var Callback = class {
  constructor(id, label, timeout2) {
    __privateAdd(this, _id, void 0);
    __privateAdd(this, _error2, new ProtocolError());
    ...
    if (timeout2) {
      __privateSet(this, _timer, setTimeout(() => {
        __privateGet(this, _deferred).reject(rewriteError(__privateGet(this, _error2), `${label} timed out. Increase the 'protocolTimeout' setting in launch/connect calls for a higher timeout if needed.`));
      }, timeout2));
    }
  }
  resolve(value) {
...
var _client, _enabled, _scriptURLs, _scriptSources, _subscriptions, _resetOnNavigation, _reportAnonymousScripts, _includeRawScriptCoverage, _onExecutionContextsCleared, onExecutionContextsCleared_fn, _onScriptParsed, onScriptParsed_fn;
var JSCoverage = class {
  ...
  async start(options = {}) {
    ...
    const clientEmitter = __privateGet(this, _subscriptions).use(new EventEmitter(__privateGet(this, _client)));
  ...
  async stop() {
    ...
    (_a4 = __privateGet(this, _subscriptions)) == null ? void 0 : _a4.dispose();
    const coverage = [];
...
var _client2, _enabled2, _stylesheetURLs, _stylesheetSources, _eventListeners, _resetOnNavigation2, _onExecutionContextsCleared2, onExecutionContextsCleared_fn2, _onStyleSheet, onStyleSheet_fn;
var CSSCoverage = class {
  ...
  async start(options = {}) {
    ...
    const clientEmitter = __privateGet(this, _eventListeners).use(new EventEmitter(__privateGet(this, _client2)));
  ...
  async stop() {
    ...
    (_a4 = __privateGet(this, _eventListeners)) == null ? void 0 : _a4.dispose();
...
var EmulationManager = (() => {
  var _client4, _emulatingMobile, _hasTouch, _states, _viewportState, _idleOverridesState, _timezoneState, _visionDeficiencyState, _cpuThrottlingState, _mediaFeaturesState, _mediaTypeState, _geoLocationState, _defaultBackgroundColorState, _javascriptEnabledState, _secondaryClients, _applyViewport, applyViewport_get, _emulateIdleState, emulateIdleState_get, _emulateTimezone, emulateTimezone_get, _emulateVisionDeficiency, emulateVisionDeficiency_get, _emulateCpuThrottling, emulateCpuThrottling_get, _emulateMediaFeatures, emulateMediaFeatures_get, _emulateMediaType, emulateMediaType_get, _setGeolocation, setGeolocation_get, _setDefaultBackgroundColor, setDefaultBackgroundColor_get, _setJavaScriptEnabled, setJavaScriptEnabled_get, _a4;
  let _instanceExtraInitializers = [];
  ...
  return _a4 = class {
    constructor(client) {
      ...
      __privateAdd(this, _client4, __runInitializers5(this, _instanceExtraInitializers));
    ...
    clients() {
      return [__privateGet(this, _client4), ...Array.from(__privateGet(this, _secondaryClients))];
    }
  ...
  }, _client4 = new WeakMap(), _emulatingMobile = new WeakMap(), _hasTouch = new WeakMap(), _states = new WeakMap(), _viewportState = new WeakMap(), _idleOverridesState = new WeakMap(), _timezoneState = new WeakMap(), _visionDeficiencyState = new WeakMap(), _cpuThrottlingState = new WeakMap(), _mediaFeaturesState = new WeakMap(), _mediaTypeState = new WeakMap(), _geoLocationState = new WeakMap(), _defaultBackgroundColorState = new WeakMap(), _javascriptEnabledState = new WeakMap(), _secondaryClients = new WeakMap(), _applyViewport = new WeakSet(), applyViewport_get = function() {
    ...
    __esDecorate5(_a4, _private_applyViewport_descriptor = { value: __setFunctionName2(async function(client, viewportState) {
    ...
    __esDecorate5(_a4, _private_emulateIdleState_descriptor = { value: __setFunctionName2(async function(client, idleStateState) {
    ...
    __esDecorate5(_a4, _private_emulateTimezone_descriptor = { value: __setFunctionName2(async function(client, timezoneState) {
    ...
    __esDecorate5(_a4, _private_emulateVisionDeficiency_descriptor = { value: __setFunctionName2(async function(client, visionDeficiency) {
    ...
    __esDecorate5(_a4, _private_emulateCpuThrottling_descriptor = { value: __setFunctionName2(async function(client, state) {
      if (!state.active) {
        return;
      }
    ...
    __esDecorate5(_a4, _private_emulateMediaFeatures_descriptor = { value: __setFunctionName2(async function(client, state) {
      if (!state.active) {
        return;
      }
    ...
    __esDecorate5(_a4, _private_emulateMediaType_descriptor = { value: __setFunctionName2(async function(client, state) {
      if (!state.active) {
        return;
      }
      await client.send("Emulation.setEmulatedMedia", {
    ...
    __esDecorate5(_a4, _private_setGeolocation_descriptor = { value: __setFunctionName2(async function(client, state) {
      if (!state.active) {
        return;
      }
    ...
    __esDecorate5(_a4, _private_setDefaultBackgroundColor_descriptor = { value: __setFunctionName2(async function(client, state) {
      if (!state.active) {
        return;
      }
    ...
    __esDecorate5(_a4, _private_setJavaScriptEnabled_descriptor = { value: __setFunctionName2(async function(client, state) {
      if (!state.active) {
        return;
      }
...
var _subjectName, _issuer, _validFrom, _validTo, _protocol, _sanList;
...
var Tracing = class {
  ...
  async start(options = {}) {
    ...
    await __privateGet(this, _client3).send("Tracing.start", {
  ...
  async stop() {
    ...
    __privateGet(this, _client3).once("Tracing.tracingComplete", async (event) => {
      try {
        assert(event.stream, 'Missing "stream"');
        const readable = await getReadableFromProtocolStream(__privateGet(this, _client3), event.stream);
    ...
    await __privateGet(this, _client3).send("Tracing.end");
...
puppeteer-core/lib/esm/puppeteer/common/SecurityDetails.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-NKYH7TOY.js.map
