...
const StoreHero = ({ store, isPublishedView = false }) => {
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-indigo-700 via-purple-700 to-pink-700 text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row justify-center md:justify-start gap-4 pt-4">
              <Button 
                size="lg"
                className="rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 hover:bg-opacity-80 transform hover:scale-105"
              ...
              <Button 
                variant="outline" 
                size="lg"
                className="rounded-lg shadow-sm hover:shadow-md transition-all duration-300 hover:text-white"
                style={{ 
          ...
          >
            <div 
              className="absolute -inset-2 rounded-xl opacity-50 group-hover:opacity-70 transition-opacity duration-300" 
            ...
            <div className="aspect-video md:aspect-[5/4] rounded-xl overflow-hidden shadow-2xl relative z-10 transform group-hover:scale-105 transition-transform duration-300 bg-black"> {/* Added bg-black for video letterboxing */}
              ...
              >
                <div className="flex items-center gap-3">
                  <div 
                    className="h-12 w-12 rounded-lg flex items-center justify-center text-white text-2xl font-bold" // Changed to rounded-lg
